...
<div class="input-group">
    <div class="btn-group btn-group-toggle ml-1" data-toggle="buttons" style="width:100%;">
    <label class="btn btn-secondary mr-2">
        <input type="radio" name="use_areas_pkmn" id="use_areas_<?php echo $pkm_unique_id; ?>" value="distance" checked>
        <?php echo i8ln("Set Distance"); ?>
    </label>
    </div>
</div>
...
<input type="hidden" id='distance_<?php echo $pkm_unique_id; ?>' name='distance' value='0'> 
