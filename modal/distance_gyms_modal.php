<div class="modal-header">
    <h5 class="modal-title" id="DistanceGymsModal">
        <?php echo i8ln("Update Distance for all tracked Gyms?"); ?>
    </h5>
...
<?php
    $stmt = $conn->prepare("SELECT distance from gym WHERE id = ? GROUP by distance");
    ...
    $stmt->close();
?>
<form action='./actions/gyms.php?action=update_gyms_distance' method='POST'>
<div class="modal-body">
    <?php echo i8ln("This will update Distance settings for ALL tracked Gyms"); ?>.<br><br>
