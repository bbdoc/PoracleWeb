                    ...
                    <?php
                        ...
                        if (isset($_GET['return']) && $_GET['return'] == 'success_added_invasion') {
                        ?>
                    <div class="alert alert-success alert-dismissible fade show" role="alert">
                        <?php echo i8ln("Successfully Added Invasion Alarm(s)"); ?>
                        <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
                    <?php
                        ...
                        if (isset($_GET['return']) && $_GET['return'] == 'success_update_invasion') {
                        ?>
                    <div class="alert alert-success alert-dismissible fade show" role="alert">
                        <?php echo i8ln("Successfully Updated Invasion Alarm"); ?>
                        <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
                    <?php
                        ...
                        if (isset($_GET['return']) && $_GET['return'] == 'success_delete_invasion') {
                        ?>
                    <div class="alert alert-success alert-dismissible fade show" role="alert">
                        <?php echo i8ln("Successfully Deleted Invasion Alarm(s)"); ?>
                        <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
                    <?php
                        ...
                        if (isset($_GET['return']) && $_GET['return'] == 'success_added_lure') {
                        ?>
                    <div class="alert alert-success alert-dismissible fade show" role="alert">
                        <?php echo i8ln("Successfully Added Lure Alarm(s)"); ?>
                        <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
                    <?php
                        ...
                        if (isset($_GET['return']) && $_GET['return'] == 'success_update_lure') {
                        ?>
                    <div class="alert alert-success alert-dismissible fade show" role="alert">
                        <?php echo i8ln("Successfully Updated Lure Alarm"); ?>
                        <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
                    <?php
                        ...
                        if (isset($_GET['return']) && $_GET['return'] == 'success_delete_lure') {
                        ?>
                    <div class="alert alert-success alert-dismissible fade show" role="alert">
                        <?php echo i8ln("Successfully Deleted Lure Alarm(s)"); ?>
                        <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
                    ...
                    <?php
                        ...
                        ?>
                    <div class="alert alert-success alert-dismissible fade show" role="alert">
                        <?php echo i8ln("Successfully Updated Distance on ALL Pokémons"); ?>
                        <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
                    <?php
                        ...
                        ?>
                    <div class="alert alert-success alert-dismissible fade show" role="alert">
                        <?php echo i8ln("Successfully Updated Distance on ALL Raids & Eggs"); ?>
                        <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
                    <?php
                        ...
                        ?>
                    <div class="alert alert-success alert-dismissible fade show" role="alert">
                        <?php echo i8ln("Successfully Updated Distance on ALL Quests"); ?>
                        <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
		    </div>
                    <?php
                        ...
                        if (isset($_GET['return']) && $_GET['return'] == 'success_update_invasions_distance') {
                        ?>
                    <div class="alert alert-success alert-dismissible fade show" role="alert">
                        <?php echo i8ln("Successfully Updated Distance on ALL Invasions"); ?>
                        <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
                    <?php
                        ...
                        if (isset($_GET['return']) && $_GET['return'] == 'success_update_lures_distance') {
                        ?>
                    <div class="alert alert-success alert-dismissible fade show" role="alert">
                        <?php echo i8ln("Successfully Updated Distance on ALL Lures"); ?>
                        <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
